...
function Footer() {
    ...
    return (
        <div className="flex-col px-4 pt-8 mx-auto  sm:max-w-xl md:max-w-full md:px-24 lg:px-8 bg-slate-800">
            <div className="flex mx-auto">
                <img className="w-80" src="https://www.jhu.edu/assets/themes/machado/assets/images/logos/university-logo-small-horizontal-white-156eae9527.svg" alt="Johns Hopkins University" />
                <div className="grid gap-40 row-gap-6 mb-8 sm:grid-cols-3 lg:grid-cols-3  ml-8">
            ...
            <div className="flex flex-col content-end pt-5 pb-10 border-t lg:flex-row">
